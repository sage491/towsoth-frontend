...
import { ArrowLeft, ChevronRight, Clock, FileText, CheckCircle2, Circle, BarChart2, PlayCircle, BookMarked, AlertTriangle, ChevronDown } from 'lucide-react';
...
interface EnterpriseTopicSelectionPageProps {
  subject: string;
  onBack: () => void;
  onNavigateToNotes: (topic: Topic) => void;
  onNavigateToSubject: () => void;
}

export function EnterpriseTopicSelectionPage({ subject, onBack, onNavigateToNotes, onNavigateToSubject }: EnterpriseTopicSelectionPageProps) {
                ...
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => {
                          onNavigateToNotes(topic);
                          showMicroFeedback('→ Opening topic materials...');
                        }}
                  ...
                  <div className="border-t px-4 py-3" style={{ background: '#F8FAFC', borderColor: '#E2E8F0' }}>
                    ...
                    <div className="mt-3 flex items-center gap-2">
                      <button
                        ...
                        className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold uppercase tracking-wider hover:bg-slate-100 transition-all"
