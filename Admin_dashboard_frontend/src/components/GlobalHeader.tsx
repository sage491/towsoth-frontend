...
import type { GlobalHeaderProps } from '../types/navigation';

export function GlobalHeader({ onNavigate }: GlobalHeaderProps) {
  ...
  return (
    <header className="h-16 bg-white border-b border-[#e5e7eb] flex items-center justify-between px-6 shrink-0 relative">
      ...
      <div className="flex items-center gap-6">
        {/* Institution Identity - Clickable Logo */}
        <InstitutionLogo 
          size="medium"
          showName={true}
          clickable={true}
        ...
        {/* Academic Session - Minimal Badge */}
        <div className="flex items-center gap-2">
          <span className="text-[11px] text-[#9ca3af]">Academic Session</span>
          <span className="text-[12px] text-[#374151] px-2 py-0.5 bg-[#f9fafb] border border-[#e5e7eb]">
            2024-2025
          </span>
        </div>
      </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1">
                          ...
                          <p className="text-[13px] text-[#111827] mt-0.5">{notif.message}</p>
                        </div>
                        <span className="text-[11px] text-[#9ca3af] whitespace-nowrap">{notif.time}</span>
                      </div>
                    </button>
                  ))}
                </div>
                <div className="px-4 py-2 border-t border-[#e5e7eb] bg-[#fafafa]">
                  <button className="text-[12px] text-[#6b7280] hover:text-[#374151] transition-colors">
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-[13px] text-[#111827] group-hover:text-[#000000] transition-colors">
                Admin Raj
              </p>
              ...
              <div className="absolute right-0 top-full mt-2 w-56 bg-white border border-[#e5e7eb] shadow-lg z-50">
                <div className="py-2">
                  <button className="w-full px-4 py-2.5 text-left hover:bg-[#f9fafb] flex items-center gap-3 transition-all group">
                    ...
                    <span className="text-[13px] font-normal text-[#374151] group-hover:text-[var(--brand-primary)] group-hover:font-semibold transition-all">Admin Settings</span>
                  </button>
                  <button className="w-full px-4 py-2.5 text-left hover:bg-[#f9fafb] flex items-center gap-3 transition-all group">
                    <Settings className="w-4 h-4 text-[#9ca3af] group-hover:text-[var(--brand-primary)] transition-colors" />
                    <span className="text-[13px] font-normal text-[#374151] group-hover:text-[var(--brand-primary)] group-hover:font-semibold transition-all">Security</span>
                  </button>
                </div>
                <div className="border-t border-[#e5e7eb] py-2">
                  <button className="w-full px-4 py-2.5 text-left hover:bg-[#f9fafb] flex items-center gap-3 transition-all group">
                    <LogOut className="w-4 h-4 text-[#9ca3af] group-hover:text-[#dc2626] transition-colors" />
                    <span className="text-[13px] font-normal text-[#374151] group-hover:text-[#dc2626] group-hover:font-semibold transition-all">Logout</span>
                  </button>
                </div>
              </div>
            </>
